...
exports.returnOrderUserMailTemplate = exports.returnOrderBankMailTemplate = void 0;
const returnOrderBankMailTemplate = (orderInfo) => {
    return `
  <p>Hi HDFC Bank,</p>
...
exports.returnOrderBankMailTemplate = returnOrderBankMailTemplate;
const returnOrderUserMailTemplate = (orderInfo) => {
    var _a;
    return `
...
exports.returnOrderUserMailTemplate = returnOrderUserMailTemplate;
